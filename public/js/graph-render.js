(function () {
    ...
    function loadGraph(props, endpoint, callback) {
        d3.json(endpoint, function (error, graph) {
            ...
            //var drag = props.force.drag().on("dragstart", addFixed);
    ...
    function triggerSidePanel(d) {
        graphInfoWidget = new GraphInfoWidget(d.endpoint);
    }
